    ...
    export default function LoginPage() {
        ...
        return (
            <Container maxWidth="sm">
                ...
                <Image src={'/images/Gradients.png'} width={420} style={{position:'absolute', bottom: 0, left: 0, zIndex: -1}} height={420} alt={'login'}></Image>
                <Container maxWidth="sm" >
                    ...
                    <Box component="form" onSubmit={handleLogin} sx={{ mt: 2 , marginTop:8}}>
                        ...
                        <Link href="/register" variant="body2" marginLeft={14}>
